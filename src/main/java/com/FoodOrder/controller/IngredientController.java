...
public class IngredientController {
    ...
    public ResponseEntity<IngredientsItem> createIngredientsItem(
        ...
        IngredientsItem ingredientsItem = ingredientsService.createIngredientsItem(request.getName(), request.getRestaurantId(), request.getIngredientCategoryId());
    ...
    public ResponseEntity<List<IngredientsItem>> getIngredientRestaurant(
            @PathVariable Long id
    ) throws Exception {
    ...
    public ResponseEntity<List<IngredientCategory>> getIngredientCategoryRestaurant(
            @PathVariable Long id
    ) throws Exception {
